...
def build_config_from_decisions(decisions: Dict[str, Any]) -> ModelConfig:
    ...
    config_kwargs = {
        ...
        "lower_arch": FUSE_DECISION_MAP["ARCH2"].get(arch2_val, LowerLayerArch.SINGLE_NOEVAP),
        "baseflow": FUSE_DECISION_MAP["ARCH2_BASEFLOW"].get(arch2_val, BaseflowType.LINEAR),
